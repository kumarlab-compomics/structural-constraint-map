...
dir=/cluster/projects/kumargroup/isoform-constraint-map/structure/combined_community_detection

#CLI arg #1: directory with pdbs

home="${HOME}/structural-constraint-map/scripts/one-conformation"
output=/cluster/projects/kumargroup/isoform-constraint-map/metrics/ensemble_conformation_metrics/output
master=/cluster/projects/kumargroup/isoform-constraint-map/metrics/ensemble_conformation_metrics
...
mkdir -p $output/ensemble_conf_residue_level_metrics
mkdir -p $output/ensemble_conf_summary_metrics
mkdir -p $output/temp
